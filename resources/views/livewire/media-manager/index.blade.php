    ...
    <div class="container mx-auto p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                <h2 class="text-3xl font-bold text-gray-800 mb-3 sm:mb-0">Media Manager Management</h2>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                                        ...
                                        <div class="space-y-4">
                                            <div>
                                                <label for="filename"
                                                    class="block text-sm font-medium text-gray-700">Filename</label>
                                                ...
                                                <div x-data="{ imagePreview: null }">
                                                    <label class="block mt-5 text-sm font-medium text-gray-700">Image</label>
